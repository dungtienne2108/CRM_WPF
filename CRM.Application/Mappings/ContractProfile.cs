    ...
    public class ContractProfile : Profile
    {
        public ContractProfile()
        {
            CreateMap<Contract, ContractDto>()
                ...
                .ForMember(d => d.ProductName, s => s.MapFrom(c => c.Deposit != null && c.Deposit.Product != null ? c.Deposit.Product.ProductName : null))
                .ForMember(d => d.ProjectId, s => s.MapFrom(c => c.Deposit != null && c.Deposit.Product != null && c.Deposit.Product.Project != null ? c.Deposit.Product.Project.ProjectId : 0))
                .ForMember(d => d.ProjectName, s => s.MapFrom(c => c.Deposit != null && c.Deposit.Product != null && c.Deposit.Product.Project != null ? c.Deposit.Product.Project.ProjectName : null))
