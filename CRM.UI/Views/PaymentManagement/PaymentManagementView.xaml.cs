...
{
    /// <summary>
    /// Interaction logic for PaymentManagementView.xaml
    /// </summary>
    public partial class PaymentManagementView : UserControl
    {
        private readonly PaymentManagementViewModel _viewModel;

        public PaymentManagementView(PaymentManagementViewModel viewModel)
        {
            InitializeComponent();
